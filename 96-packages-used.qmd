...
{**aplpack**}: [Another Plot Package: 'Bagplots', 'Iconplots', 'Summaryplots', Slider Functions and Others](https://www.uni-bielefeld.de/fakultaeten/wirtschaftswissenschaften/fakultaet/lehrende-ehemalige/pwolf/wolf_aplpack/index.xml) [@aplpack]
...
{**ggExtra**}: [Add Marginal Histograms to 'ggplot2', and More 'ggplot2' Enhancements](https://github.com/daattali/ggExtra) [@ggExtra]
...
{**plotrix**}: [Various Plotting Functions](https://plotrix.github.io/plotrix/) [@plotrix]
...
{**rgl**}: [3D Visualization Using OpenGL](https://dmurdoch.github.io/rgl/) [@rgl]

(*There is no hexagon logo for {**rgl**} available*)

Provides medium to high level functions for 3D interactive graphics, including functions modelled on base graphics (`plot3d()`, etc.) as well as functions for constructing representations of geometric objects (`cube3d()`, etc.). Output may be on screen using [OpenGL](https://www.opengl.org/), or to various standard 3D file formats including [WebGL](https://www.khronos.org/webgl/), PLY, OBJ, STL as well as 2D image formats, including PNG, Postscript, SVG, PGF.
...
- GLU Library (Required for display in R. [for Windows, but not for MacOS???] See "Installing OpenGL support" in README.md. Not needed if only browser displays using `rglwidget()` are wanted.) See For [WebGL display](https://get.webgl.org) to get browser with WebGL enabled.
- zlib (optional), 
